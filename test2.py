...
print 'counted_values', idf
#tf
emails_jay = json_lay.filter(lambda x: 'kenneth.lay@enron.com' in x['sendor'].lower())
emails_fastow = json_lay.filter(lambda x: 'andrew.fastow@enron.com' in x['sendor'].lower())
